          ...
          nixos-gate-3-contract =
            ...
            harness.mkTest {
              ...
              testScript = ''
                ...
                gateway.succeed("journalctl -u telchar-daemon.service --no-pager | grep -q 'operation=AddMultipleToStore' || { journalctl -u telchar-daemon.service --no-pager >&2; exit 1; }")
