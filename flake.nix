          ...
          nixos-gate-3-contract =
            ...
            harness.mkTest {
              ...
              testScript = ''
                ...
                gateway.succeed("sudo -u postgres psql -d telchar-ingress -v ON_ERROR_STOP=1 -Atc \"SELECT count(*) FROM store_leases WHERE owner_kind = 'request' AND state = 'active'\" | grep -qx 0")
                ...
                gateway.succeed("test \"$(find /var/lib/telchar-gc-roots -mindepth 1 -maxdepth 1 -print -quit)\" = \"\"")
