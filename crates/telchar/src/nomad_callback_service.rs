...
use crate::nomad_callback_http::{handle_connection, CallbackHttpLimits};
...
pub fn serve_connection(
    ...
    handle_connection(connection, limits, |method, path, body| {
        ...
        match backend.transfer_authentication() {
            NomadTransferAuthentication::WorkloadIdentity {
                ...
                .admit(body, method, path, SystemTime::now())?;
            }
