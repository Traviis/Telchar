...
pub struct SessionBuilder<'a> {
    ...
    running_disconnect_policy: Option<crate::deployment::RunningDisconnectPolicy>,
    output_retention: Option<crate::deployment::OutputRetention>,
    ...
    store_export: Option<&'a mut dyn crate::store_export::StoreExportBackend>,
    store_import: Option<&'a mut dyn crate::store_import::StoreImportBackend>,
    store_closure: Option<&'a mut dyn crate::store_closure::StoreClosureBackend>,
    store_retention: Option<&'a mut dyn crate::store_retention::StoreRetentionBackend>,
    database_url: Option<&'a str>,
    session_id: Option<&'a str>,
    audit_subject: Option<&'a str>,
    quota_subject: Option<&'a str>,
    transfer_limits: Option<&'a crate::transfer_limits::TransferLimits>,
    object_admission: Option<&'a crate::transfer_limits::ObjectAdmissionState>,
    rate_admission: Option<&'a crate::transfer_limits::RateAdmissionState>,
    disk_reserve: Option<crate::disk_reserve::DiskReserve>,
    disk_probe: Option<&'a dyn crate::disk_reserve::DiskReserveProbe>,
    shared_builds: Option<&'a crate::shared_build::SharedBuildRegistry>,
    shared_build_scheduler: Option<&'a crate::shared_build_scheduler::SharedBuildScheduler>,
    scheduling_limits: Option<crate::config::SchedulingLimits>,
}
...
pub(super) struct SessionContext<'a> {
    ...
    pub running_disconnect_policy: crate::deployment::RunningDisconnectPolicy,
    pub output_retention: crate::deployment::OutputRetention,
    ...
    pub store_export: &'a mut dyn crate::store_export::StoreExportBackend,
    pub store_import: &'a mut dyn crate::store_import::StoreImportBackend,
    pub store_closure: &'a mut dyn crate::store_closure::StoreClosureBackend,
    pub store_retention: &'a mut dyn crate::store_retention::StoreRetentionBackend,
    pub database_url: &'a str,
    pub session_id: &'a str,
    pub audit_subject: &'a str,
    pub quota_subject: &'a str,
    pub transfer_limits: &'a crate::transfer_limits::TransferLimits,
    pub object_admission: &'a crate::transfer_limits::ObjectAdmissionState,
    pub rate_admission: &'a crate::transfer_limits::RateAdmissionState,
    pub disk_reserve: crate::disk_reserve::DiskReserve,
    pub disk_probe: &'a dyn crate::disk_reserve::DiskReserveProbe,
    pub shared_builds: &'a crate::shared_build::SharedBuildRegistry,
    pub shared_build_scheduler: &'a crate::shared_build_scheduler::SharedBuildScheduler,
    pub scheduling_limits: crate::config::SchedulingLimits,
}
...
impl<'a> SessionBuilder<'a> {
    ...
    pub fn disconnect_policy(mut self, value: crate::deployment::RunningDisconnectPolicy) -> Self {
        self.running_disconnect_policy = Some(value);
        self
    }
    pub fn retention(
        mut self,
        value: crate::deployment::OutputRetention,
    ...
    pub fn stores(
        ...
        export: &'a mut dyn crate::store_export::StoreExportBackend,
        import: &'a mut dyn crate::store_import::StoreImportBackend,
        closure: &'a mut dyn crate::store_closure::StoreClosureBackend,
        retention: &'a mut dyn crate::store_retention::StoreRetentionBackend,
    ) -> Self {
    ...
    pub fn transfer_admission(
        mut self,
        limits: &'a crate::transfer_limits::TransferLimits,
        objects: &'a crate::transfer_limits::ObjectAdmissionState,
        rate: &'a crate::transfer_limits::RateAdmissionState,
    ) -> Self {
    ...
    pub fn disk_admission(
        ...
        probe: &'a dyn crate::disk_reserve::DiskReserveProbe,
    ) -> Self {
    ...
    pub fn shared_builds(
        ...
        scheduler: &'a crate::shared_build_scheduler::SharedBuildScheduler,
        limits: crate::config::SchedulingLimits,
    ) -> Self {
