...
| Cross-version or alternate-client compatibility | one pinned stock Nix 2.34.8 matrix cell | Deferred | Telchar supports exactly one pinned stock Nix version. Additional Nix releases and Lix require concrete traffic capture, primary-source inventory, and a matrix expansion. |
