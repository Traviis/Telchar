...
require "$adr" 'They always write to standard error.'
require "$adr" 'Standard output belongs exclusively to the selected command'
require "$adr" 'local telemetry must never write there.'
