...
require "$matrix" 'untrusted-classic-build-v1'
require "$matrix" 'Untrusted trace accepted'
require "$matrix" 'Unsupported for MVP'
require "$matrix" 'concrete content-addressed fixture'
require "$matrix" 'typed observer coverage'
require "$matrix" 'required operations and result semantics'
